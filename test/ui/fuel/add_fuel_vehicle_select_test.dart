...
import 'package:fuel_service_log/ui/fuel/fuel_form.dart';
...
void main() {
  ...
  setUp(() async {
    ...
    tempDir = await Directory.systemTemp.createTemp('hive_fuel_form_test_');
  ...
  group('FuelForm Vehicle Selector Tests', () {
    testWidgets('Shows vehicle dropdown when multiple vehicles exist', (tester) async {
      ...
      await tester.pumpWidget(
        buildTestApp(
          FuelForm.add(vehicleId: 'v1', settings: mockSettings),
        ),
      );
    ...
    testWidgets('Edit mode shows correct vehicle', (tester) async {
      ...
      await tester.pumpWidget(
        buildTestApp(
          FuelForm.edit(initial: existingEntry, settings: mockSettings),
        ),
      );
    ...
    testWidgets('No dropdown shown when no vehicles exist', (tester) async {
      await tester.pumpWidget(
        buildTestApp(
          FuelForm.add(vehicleId: null, settings: mockSettings),
        ),
      );
